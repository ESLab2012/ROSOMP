...
// ROSOMP Functions
#define FTN_OMP_INIT_NODE_CP omp_init_Node_CP
#define FTN_OMP_GET_PTHREAD_NUM omp_get_pthread_num
#define FTN_OMP_GET_PTHREAD_TID omp_get_pthread_tid
#define FTN_OMP_INIT_CNODE omp_init_cnode
#define FTN_OMP_FIND_NODE omp_find_node
#define FIN_OMP_SET_STRATEGY omp_set_strategy
#define FIN_OMP_SET_EXECUTOR_THREAD_NUM omp_set_executor_thread_num
#define FIN_OMP_SET_TID_MAP omp_set_tid_map
#define FIN_OMP_SET_PRIORITY omp_set_priority
#define FIN_OMP_GET_PRIORITY omp_get_priority
#define FTN_OMP_SYNCHRONIZATION omp_synchronization
#define FTN_OMP_SET_WAIT_FOR_WORK_FLAG omp_set_wait_for_work_flag
#define FTN_OMP_GET_WAIT_FOR_WORK_FLAG omp_get_wait_for_work_flag
#define FTN_OMP_SET_WAIT_FOR_WORK_FLAG_PICAS omp_set_wait_for_work_flag_picas
#define FTN_OMP_GET_WAIT_FOR_WORK_FLAG_PICAS omp_get_wait_for_work_flag_picas
#define FTN_OMP_QUEUE_INIT omp_queue_init
#define FTN_OMP_QUEUE_EMPTY_CHECK omp_queue_empty_check
#define FTN_OMP_DEQUEUE_AND_EXECUTE omp_dequeue_and_execute 
