...
protected:
  ...
  RCLCPP_PUBLIC
  bool
  get_next_ready_executable_picas(AnyExecutable & any_executable);
  ...
  RCLCPP_PUBLIC
  int
  Call_Comparison_picas(AnyExecutable & any_executable);
  ...
  RCLCPP_PUBLIC
  bool
  get_next_ready_executable_from_map_picas(
    AnyExecutable & any_executable,
    const WeakCallbackGroupsToNodesMap & weak_groups_to_nodes);
